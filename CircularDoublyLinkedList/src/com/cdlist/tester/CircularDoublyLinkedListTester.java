...
import com.cdlist.operation.CircularDoublyLinkedList;
import com.cdlist.operation.CircularDoublyList;
...
public class CircularDoublyLinkedListTester {
	public static void main(String[] args) {
		...
		CircularDoublyList clist = new CircularDoublyLinkedList();
		...
		do {
			...
			switch(choice) {
				...
				case 8:
					...
					clist.deleteNode(ddata);
					break;
										
			   case 9:
				   clist.showDoublyCircularLinkedList();
				   break;
			}
